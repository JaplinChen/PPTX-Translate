        ...
        <div className="modal-backdrop">
            <div className="modal is-draggable" ref={modalRef} style={{ top: position.top, left: position.left }}>
                ...
                <div className="modal-tabs">
                    <button className={`tab-btn ${tab === "glossary" ? "is-active" : ""}`} type="button" onClick={() => setTab("glossary")}>術語</button>
...
function DataTable({ items, isGlossary, editingKey, draft, saving, makeKey, setDraft, onEdit, onSave, onCancel, onDelete, onConvertToGlossary }) {
